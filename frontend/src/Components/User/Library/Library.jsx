    ...
    <section>
        <div class="container">
            <div class="row">
                ...
                <div>
                <button type="button" class="btn btn-outline-primary" id='libb1' onClick={loadInstalledApps}>ALL</button>
                <button type="button" class="btn btn-outline-secondary" id='libb2' onClick={loadWishlist}>Wishlist</button>
                </div><br /><br />
                {view==='wishlist'?(
