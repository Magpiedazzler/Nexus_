                    ...
                    <div className="container">
                        <div className="row">
                            <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xl-6" id='second_div'>
                                <div align='center'>
                                    <img src={`http://localhost:4000/img/${selectedData?.appIcon}`} alt="Sample app icon" id='img1' />
                                </div><br />
                        ...
                        <div align='center' id='subdiv1'>
                            ...
                            <div id='sub1'>
                                ...
                                <div align='center'>
                                    <button id='btn3' align='center'><i class="bi bi-flag" id='flag' onClick={() => navigate(`/report/${selectedData?._id}`)}></i>Report app</button>
                                    <button id='btn4' align='center'><i class="bi bi-heart" id='flag' onClick={() => addToWishlistFun(userId, selectedData)}></i>Add to wishlist</button>
                                </div>
                            </div>
